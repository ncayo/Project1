          ...
          <div class="row-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-tittle">Selamat datang di Project UTS</h3>
                <div class="card-body">
                   <h4>Nama : Nurcahyo </h4> </br>
                   <h4>NIM : 0110221149 </h4> </br>
                   <h4>Prodi : Teknik Informatika </h4> </br>
                   <h4>Angkatan : 2021 </h4> </br>
                </div>
              </div>
            </div>
          </div>
